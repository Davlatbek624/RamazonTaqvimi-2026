...
const NEWS_CONTENT = {
  uz: [
    ...
    { id: 2, title: "Saharlikning shifobaxsh xususiyatlari", fullText: "Saharlik qilish sunnat amal bo'lib, unda katta baraka bor. Tibbiyot mutaxassislari saharlikda murakkab uglevodlar (bo'tqalar) va ko'proq suv ichishni tavsiya qilishadi. Bu kun davomida organizmning tetik turishini ta'minlaydi.", date: "2026-02-19", tag: "Salomatlik" },
    { id: 3, title: "Zakot va Fitr sadaqasi miqdori", fullText: "2026-yil uchun O'zbekiston Musulmonlari idorasi tomonidan zakot nisobi va fitr sadaqasining miqdorlari belgilandi. Bu yilgi zakot nisobi o'tgan yilga nisbatan biroz o'zgargan. Fitr sadaqasini vaqtida berish kambag'allarning ham bayram qilshiga sabab bo'ladi.", date: "2026-02-20", tag: "Fiqh" }
  ],
  uz_kr: [
    ...
    { id: 2, title: "Саҳарликнинг шифобахш хусусиятлари", fullText: "Саҳарлик қилиш суннат амал бўлиб, унда катта барака бор. Тиббиёт мутахассислари саҳарликда мураккаб углеводлар ва кўпроq сув ичишни тавсия қилишади.", date: "2026-02-19", tag: "Саломатлик" }
  ]
};
